...
import static com.elasticapi.Constant.INDEX;
import static com.elasticapi.Constant.TYPE;
...
public class ProfileService {
	...
	public String createProfileDocument(ProfileDocument document) throws Exception {
		...
		// IndexRequest indexRequest = new IndexRequest("lisha", TYPE, "4")
		// .source(convertProfileDocumentToMap(document), XContentType.JSON);
	...
	public List<ProfileDocument> searchByTechnology(String technology) throws Exception {
		...
		// searchSourceBuilder.query(QueryBuilders.nestedQuery("technologies",QueryBuilders.boolQuery().,ScoreMode.Avg));
		searchRequest.source(searchSourceBuilder);
